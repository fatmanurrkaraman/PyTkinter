...
hatirlatma_tipi_etiket=Label(frame_ust,background="#add8e6",text="YATIRILAN  TUTAR:",font="Verdana 12 bold")
...
check_text=Label(frame_alt,background="#add8e6",text="YATIRILAN TUTAR DOĞRU MU?",font="Verdana 12 bold")
