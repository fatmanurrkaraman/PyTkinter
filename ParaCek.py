...
cekme_butonu = Button(frame_ust_sol, text="20 TL", font='Arial 15 bold', bg='#add8e6', width=50, height=8)
cekme_butonu.pack()

transfer_butonu = Button(frame_ust_sag, text="40 TL", font='Arial 15 bold', bg='#add8e6', width=50, height=8)
transfer_butonu.pack()

mevduat_butonu = Button(frame_alt_sol, text="100 TL", font='Arial 15 bold', bg='#add8e6', width=50, height=8)
mevduat_butonu.pack()

bakiye_butonu = Button(frame_alt_sag, text="Miktar Giriniz", font='Arial 15 bold', bg='#add8e6', width=50, height=8)
bakiye_butonu.pack()
